---
title: Testando queries GraphQL em React
author: Janderson Constantino
date: 2020-05-13
hero: ./images/hero.jpeg
excerpt: Testando queries GraphQL em React
---
...
const mocks = [
  {
    ...
    result: {
      // Pode ser um object, uma função ou um erro
      data: {
        users: {
          items: [{ id: 1, name: "Marcelino" }],
        },
      },
    },
  },
...
const defaultMocks = [
  {
    ...
    result: {
      data: {
        users: {
          items: [{ id: 1, name: "Michael Douglas" }],
        },
      },
    },
  },
...
describe("Tests Users", () => {
  it("should NOT should table when request not return items", async () => {
    ...
    await waitFor(() => {
      // esperamos pela conclusão do request
...
Deseja ver o código que foi feito? de uma olhada no repositório no [github](http://github.com/JandersonConstantino/how-to-test-graphql-queries).

[Postagem Original](https://medium.com/@jandersonconstantino/testando-queries-graphql-c014a44cd6db)
